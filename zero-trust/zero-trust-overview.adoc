...
資料是貴組織最重要的資產。根據 2022 年的報告，內部威脅是造成 18% 資料外洩事件的原因 https://www.verizon.com/business/resources/["Verizon 資料外洩調查報告"^]。組織可以透過部署業界領先的零信任控制措施，藉助 NetApp ONTAP 資料管理軟體來強化資料安全性。
