...
如需 ONTAP System Manager 、 Active IQ Unified Manager 和 SSH 的 MFA 相關資訊，請參閱 link:https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["TR-4647 ： ONTAP 9 中的多因素驗證"^]。
