...
link:https://www.netapp.com/pdf.html?item=/media/83591-tr-4963.pdf["TR-4963：安全強化指南： NetApp Backup and Recovery"^]了解如何設定NetApp Cloud Backup for Applications，以協助組織滿足資訊系統機密性、完整性和可用性的規定安全目標。
